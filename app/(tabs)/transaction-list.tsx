      ...
      <TransactionListSkeleton isLoading={loading}>
        <View className="flex-1">
          ...
          <View className="flex flex-row gap-2 px-4 py-2">
            <TouchableOpacity className="flex-row items-center justify-center rounded-lg bg-pale-green px-2 py-3" onPress={() => setAddModalVisible(true)}>
              <Plus color="white" size={20} />
              <Text className="ml-2 font-semibold text-white">Add Transaction</Text>
            </TouchableOpacity>

            <TouchableOpacity className="flex-row items-center justify-center rounded-lg bg-pale-green px-2 py-3" onPress={() => setCapitalModalVisible(true)}>
              <DollarSign color="white" size={20} />
              <Text className="ml-2 font-semibold text-white">Update Initial Capital</Text>
            </TouchableOpacity>
          </View>
