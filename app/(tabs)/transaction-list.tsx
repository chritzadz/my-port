...
export default function TransactionListScreen() {
  ...
  return (
    <>
      <GeneralView className={"bg-ivory"} title={"Transaction List"}>
      ...
      <View className="absolute bottom-24 right-6 items-center gap-3">
        <TouchableOpacity className="bg-muted h-14 w-14 items-center justify-center rounded-full shadow-lg" onPress={() => setCapitalModalVisible(true)}>
          <DollarSign color="white" size={24} />
        </TouchableOpacity>
        <TouchableOpacity className="bg-muted h-14 w-14 items-center justify-center rounded-full shadow-lg" onPress={() => setAddModalVisible(true)}>
